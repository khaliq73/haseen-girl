...
export default function Web() {
  ...
  return (
  <div className=" min-h-screen fixed inset-0 bg-linear-to-br from-black via-purple-950 to-pink-900 flex flex-col items-center justify-center text-center overflow-hidden h-screen">
