...
export default function Web() {
  ...
  return (
   <div className="fixed inset-0 bg-linear-to-br from-black via-purple-950 to-pink-900 flex flex-col items-center justify-center px-6 text-center overflow-hidden">
